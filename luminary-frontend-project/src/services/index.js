...
export const ENDPOINTS = {
  ...
  billing: {
    ...
    collectionsReport: { method: 'GET', path: '/reports/collections' },
    listCollectionCases: { method: 'GET', path: '/collections/cases' },
    createCollectionCase: { method: 'POST', path: '/collections/cases' },
    getCollectionCase: { method: 'GET', path: '/collections/cases/:id' },
    updateCollectionCase: { method: 'PATCH', path: '/collections/cases/:id' },
    recordCollectionAction: { method: 'POST', path: '/collections/cases/:id/actions' },
    listWorkItems: { method: 'GET', path: '/billing/work-items', permission: 'viewBillingHandoff' },
    getWorkItem: { method: 'GET', path: '/billing/work-items/:id', permission: 'viewBillingHandoff', note: 'billing-safe encounter summary, never the SOAP note' },
    requestClarification: { method: 'POST', path: '/billing/work-items/:id/clarifications', permission: 'requestBillingClarification' },
    respondClarification: { method: 'POST', path: '/billing/clarifications/:id/response', permission: 'requestBillingClarification' },
    addCatalogueLine: { method: 'POST', path: '/billing/draft-invoices/:id/catalogue-lines', permission: 'addCatalogueInvoiceLine' },
    addCustomLine: { method: 'POST', path: '/billing/draft-invoices/:id/custom-lines', permission: 'addCustomInvoiceLine' },
    updateDraftLine: { method: 'PATCH', path: '/billing/draft-invoices/lines/:lineId', note: 'quantity needs editDraftInvoice; unitPrice needs overrideInvoicePrice + reason' },
    excludeDraftLine: { method: 'POST', path: '/billing/draft-invoices/lines/:lineId/exclude', permission: 'excludeAutomatedInvoiceLine' },
    restoreDraftLine: { method: 'POST', path: '/billing/draft-invoices/lines/:lineId/restore', permission: 'excludeAutomatedInvoiceLine' },
    applyBespokePrice: { method: 'POST', path: '/billing/draft-invoices/lines/:lineId/bespoke-price', permission: 'overrideInvoicePrice' },
    reorderDraftLines: { method: 'POST', path: '/billing/draft-invoices/:id/reorder', permission: 'editDraftInvoice' },
    setPatientNote: { method: 'PATCH', path: '/billing/draft-invoices/:id/patient-note', permission: 'editDraftInvoice' },
    finalizeInvoice: { method: 'POST', path: '/billing/work-items/:id/finalize', permission: 'finalizeInvoice', note: 'locks the invoice; corrections after this use adjustments/reversals, never a line edit' },
    createBespokePrice: { method: 'POST', path: '/patients/:patientId/bespoke-prices', note: 'created pending; needs approveBespokePrice to activate' },
    approveBespokePrice: { method: 'POST', path: '/bespoke-prices/:id/approve', permission: 'approveBespokePrice' },
  },
